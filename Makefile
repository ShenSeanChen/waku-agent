# milli-agent — one command per pillar.
#
...
run:            ## chat with Milli in the terminal
	$(PY) -m milli

voice:          ## talk to it — push-to-talk, or always-on with MILLI_WAKE_WORD
	$(PY) -m milli voice
...
lint:
	$(PY) -m ruff check milli evals scripts
