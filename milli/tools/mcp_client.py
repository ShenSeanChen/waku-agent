"""MCP connector — plug any Model Context Protocol server into Milli's tools.

Milli's loop is synchronous; the MCP SDK is async. The bridge below runs one
