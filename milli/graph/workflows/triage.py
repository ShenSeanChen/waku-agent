...
from milli.graph.engine import END, START, Graph, Node
from milli.graph.nodes import key_router
...
QUICK_REPLY_PROMPT = """\
You are Milli, a warm, concise personal assistant. The user's message needs no
