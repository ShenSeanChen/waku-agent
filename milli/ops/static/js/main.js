// milli dashboard — render/refresh loop, resizers/chrome, voice, bootstrap (LOADS LAST).
...
const TITLES = {chat:"Chat & watch", ops:"LLM Ops",
                ...
                database:"Database — everything Milli stores (state.db)"};
function render(){
  if (!D) return;
...
const micHint = (msg) => { const i = document.getElementById("dmsg");
  if (i){ i.placeholder = msg; setTimeout(()=>{ i.placeholder = "Message Milli…"; }, 8000); } };
