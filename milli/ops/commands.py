...
Two kinds of graph ship in Milli and conflating them made the UI say something
...
DISCOVERY, and why it is shaped this way: a module in milli/graph/workflows/ is
...
makes it testable. What makes a workflow runnable is its BINDER in milli/ops/,
where real callables meet the pure shape.

So the rule is: `milli/graph/workflows/<name>.py` plus `milli/ops/<name>.py`
