"""`python -m milli.ops.show_trace` — read a JSONL trace as a terminal timeline.

Pass a trace file directly, or omit it to show the most recent trace in MILLI_HOME
(the current directory's .milli/ by default). Trace records are printed one at a
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Render a Milli JSONL trace as a terminal timeline."
    )
    parser.add_argument(
